...
- Authors: Jiangyun Li, Xiaochen Zhang, Tong Gu, Hao Wang, Hao Du, and Peixian Zhuang
...
├── model/
│   ├── ccfnet.py      # Main network architecture
...
- `algorithm`: The algorithm for training (e.g., `ccfnet`)
